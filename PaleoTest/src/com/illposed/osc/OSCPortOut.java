...
public class OSCPortOut extends OSCPort {
	...
	protected InetAddress address;
			//
			//getByAddress("172.16.22.182"); 
			//InetSocketAddress("172.16.22.182",7000);
	...
	public OSCPortOut() throws UnknownHostException, SocketException {
		...
		//this(InetAddress.getLocalHost(), 7000);
		//this(InetAddress.getByName("172.16.22.182"), 7000);
		this(InetAddress.getLocalHost(), 12000);
	}
