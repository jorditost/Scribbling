/*
 * scribblingDP2Palette
 * This sketch controls the Sketch Recognition.
 * Modes and color are controlled by a controlP5 Palette 
 */
...
public void controlEvent(ControlEvent theEvent) {
  ...
  Controller button = theEvent.getController();
  ...
  if (buttonName == "mode") {
    ...
    if (inputMode == DRAWING_MODE) {
      inputMode = GESTURE_MODE;
      button.setLabel("Drag");
      button.setColorBackground(#eeeeee);
      button.setColorLabel(#000000);
      println("Mode changed - GESTURE");
      cp5.getController("r").setColorBackground(#ffbbbb);
      cp5.getController("g").setColorBackground(#bbffbb);
      cp5.getController("b").setColorBackground(#bbbbff);
      cp5.getController("k").setColorBackground(#bbbbbb);
    } 
    else {
      inputMode = DRAWING_MODE;
      restartDrawingMode = true;
      button.setLabel("Draw");
      button.setColorBackground(#000000);
      button.setColorLabel(#ffffff);
      println("Mode changed - DRAWING");
    }
  }
  ...
  if (buttonName == "r" || (restartDrawingMode && drawColor == #FF0000)) {
    println("Color changed - RED");
    drawColor = #FF0000;
    button.setColorBackground(drawColor);
    cp5.getController("g").setColorBackground(#bbffbb);
    cp5.getController("b").setColorBackground(#bbbbff);
    cp5.getController("k").setColorBackground(#bbbbbb);
  } 
  else if (buttonName == "g" || (restartDrawingMode && drawColor == #00FF00)) {
    println("Color changed - GREEN");
    drawColor = #00FF00;
    button.setColorBackground(drawColor);
    cp5.getController("r").setColorBackground(#ffbbbb);
  ...
  else if (buttonName == "b" || (restartDrawingMode && drawColor == #0000FF)) {
    println("Color changed - BLUE");
    drawColor = #0000FF;
    button.setColorBackground(drawColor);
    cp5.getController("r").setColorBackground(#ffbbbb);
  ...
  else if (buttonName == "k" || (restartDrawingMode && drawColor == #000000)) {
    println("Color changed - BLACK");
    drawColor = #000000;
    button.setColorBackground(drawColor);
    cp5.getController("r").setColorBackground(#ffbbbb);
